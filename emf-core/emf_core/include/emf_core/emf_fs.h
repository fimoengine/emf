#ifndef EMF_INTERFACE_C_EMF_FS_H
#define EMF_INTERFACE_C_EMF_FS_H
...
#define EMF_FILE_HANDLER_DEFAULT_HANDLE                                                                                          \
    emf_file_handler_t { EMF::C::emf_fs_predefined_handles_default }
#else
#define EMF_PATH_INIT(PATH)                                                                                                      \
    (emf_path_t) { PATH, strlen(PATH) }
#define EMF_FILE_HANDLER_DEFAULT_HANDLE                                                                                          \
 ...
 */
EMF_SPAN_TYPEDEF(emf_fs_buffer_t, const char)
...
EMF_FUNCTION_PTR_T(emf_file_handler_interface_stream_write, size_t, emf_file_handler_stream_t stream,
    const emf_fs_buffer_t* EMF_NOT_NULL buffer, size_t write_count)
...
#endif // !EMF_INTERFACE_C_EMF_FS_H
