...
#include <emf_core_bindings/version.h>

using namespace EMF::Core::C;

namespace EMF::Core::Bindings::C {

constexpr emf_version_t s_emf_core_version { EMF_CORE_BINDINGS_VERSION_MAJOR, EMF_CORE_BINDINGS_VERSION_MINOR,
    EMF_CORE_BINDINGS_VERSION_PATCH, EMF_CORE_BINDINGS_BUILD, EMF_CORE_BINDINGS_PRE_RELEASE_NUMBER,
    static_cast<emf_version_release_t>(EMF_CORE_BINDINGS_PRE_RELEASE_TYPE) };
