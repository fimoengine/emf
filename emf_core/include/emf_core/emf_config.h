//! # Introduction
//!
//! The `config` system consists of namespaces and properties. Namespaces can contain properties and other namespaces. Properties
//! are homogenous arrays of values. A namespace- or property-name must be a `UTF-8` string. All Namespaces are implicitly nested
...
//! - String (`char*`)
//!
//! Strings are treated as a sized blob of data, and as such can contain values other than strings. Unless stated otherwise, a
//! string property represents a `UTF-8` string without a terminating `\0` character.
//!
//! The array length of a property can not be changed after it's construction. Additionally, String properties are assigned a
//! maximum length at construction.
//!
//! # Example
//!
//! ## JSON
...
//! emf_unlock();
//! ```
#ifndef EMF_CORE_EMF_CONFIG_H
#define EMF_CORE_EMF_CONFIG_H
