#ifndef EMF_CORE_EMF_LIBRARY_H
#define EMF_CORE_EMF_LIBRARY_H
...
#define EMF_LIBRARY_LOADER_DEFAULT_HANDLE                                                                                        \
    emf_library_loader_handle_t { EMF::Core::C::emf_library_predefined_handles_native }
#else
#define EMF_LIBRARY_LOADER_DEFAULT_HANDLE                                                                                        \
